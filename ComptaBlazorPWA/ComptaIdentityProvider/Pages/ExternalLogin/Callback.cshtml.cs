...
namespace ComptaIdentityProvider.Pages.ExternalLogin;
...
public class Callback : PageModel
{
    ...
    private async Task<ApplicationComptaUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
    {
        var sub = Guid.NewGuid().ToString();
            
        var user = new ApplicationComptaUser
        {
            Id = sub,
